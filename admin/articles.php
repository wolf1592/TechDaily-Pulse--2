    ...
    <div class="flex">
        <aside class="w-64 bg-white h-screen p-6">
            ...
            <nav class="space-y-4">
                ...
                <a href="/web/2/admin/articles.php" class="block text-orange-600 font-bold">Haberler</a>
        ...
        <main class="flex-grow p-8">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="/web/2/admin/article_edit.php" class="bg-orange-600 text-white px-4 py-2 rounded">Yeni Haber Ekle</a>
            </div>
            <table class="w-full bg-white rounded shadow">
                ...
                <tbody>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="p-4">
                            <a href="/web/2/admin/article_edit.php?id=<?php echo $article['id']; ?>" class="text-blue-600 mr-2">Düzenle</a>
